...
function filmes({ SeriesNow , topRated , pagina  }) {
    ...
    const [serieSearched, setSerierSearched] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(topRated);
    ...
    async function searchTv(e) {
        e.preventDefault();
        const queryI = await axios__WEBPACK_IMPORTED_MODULE_4__["default"].get(`https://api.themoviedb.org/3/search/tv?api_key=86ff22163d48cfd8567997262922738a&language=en-US&page=1&query=${query}&include_adult=false`);
        setQuery("");
    ...
    async function OrderNarPor() {
        if (ordernar === "") {
            ...
            const query = await axios__WEBPACK_IMPORTED_MODULE_4__["default"].get(`https://api.themoviedb.org/3/discover/tv?api_key=86ff22163d48cfd8567997262922738a&language=pt-br&sort_by=${ordernar}&page=1&with_genres=${categoria}&include_null_first_air_dates=false&with_watch_monetization_types=flatrate&with_status=0&with_type=0`);
            setSerierSearched(query.data.results);
        }
    }
    const testee = async ()=>{
        if (categoria === "0") {
            const query = await axios__WEBPACK_IMPORTED_MODULE_4__["default"].get(`https://api.themoviedb.org/3/discover/tv?api_key=86ff22163d48cfd8567997262922738a&language=pt-br&sort_by=popularity.desc&page=1&include_null_first_air_dates=false&with_watch_monetization_types=flatrate&with_status=0&with_type=0`);
            setSerierSearched(query.data.results);
        } else {
            const query1 = await axios__WEBPACK_IMPORTED_MODULE_4__["default"].get(`https://api.themoviedb.org/3/discover/tv?api_key=86ff22163d48cfd8567997262922738a&language=en-US&sort_by=${ordernar}&page=1&timezone=America%2FNew_York&with_genres=${categoria}&include_null_first_air_dates=false&with_watch_monetization_types=flatrate&with_status=0&with_type=0`);
            setSerierSearched(query1.data.results);
        }
    };
    async function paginacoes(e) {
        ...
        if (categoria === "0") {
            if (e.currentTarget.id !== "next") {
                ...
                setpage(page + 1);
                const query1 = await axios__WEBPACK_IMPORTED_MODULE_4__["default"].get(`https://api.themoviedb.org/3/discover/tv?api_key=86ff22163d48cfd8567997262922738a&language=pt-br&sort_by=popularity.desc&page=${page}&include_null_first_air_dates=false&with_watch_monetization_types=flatrate&with_status=0&with_type=0`);
                setSerierSearched(query1.data.results);
            }
        } else {
            if (e.currentTarget.id !== "next") {
                ...
                setSerierSearched(query2.data.results);
            } else {
                setpage(page + 1);
                const query3 = await axios__WEBPACK_IMPORTED_MODULE_4__["default"].get(`https://api.themoviedb.org/3/discover/tv?api_key=86ff22163d48cfd8567997262922738a&language=en-US&sort_by=${ordernar}&page=${page}&timezone=America%2FNew_York&with_genres=${categoria}&include_null_first_air_dates=false&with_watch_monetization_types=flatrate&with_status=0&with_type=0`);
                setSerierSearched(query3.data.results);
            }
        }
    }
                ...
                children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                    ...
                    children: [
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("h3", {
                            ...
                            children: "Assistir S\xe9ries Online-\xdaltimos Epis\xf3dios"
                        }),
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                            className: (_styles_Post_module_css__WEBPACK_IMPORTED_MODULE_10___default().cntn),
                            children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((react_slick__WEBPACK_IMPORTED_MODULE_6___default()), {
                                ...settings,
                                children: SeriesNow.map((e)=>{
                                                                ...
                                                                children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("select", {
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("option", {
                                                                            className: "option",
                                                                            value: "10759",
                                                                            children: "A\xe7\xe3o e aventura"
                                                                        }),
                                                                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("option", {
                                                                            className: "option",
                                                                            value: "16",
                                                                            children: "Anima\xe7\xe3o"
                                                                        }),
                                                                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("option", {
                                                                            className: "option",
                                                                            value: "35",
                                                ...
                                                children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                                            ...
                                                            children: [
                                                                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("span", {
                                                                    children: String(e.first_air_date).slice(0, 4)
                                                                }),
                                                                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("span", {
...
async function getServerSideProps() {
    const SeriesNow = await axios__WEBPACK_IMPORTED_MODULE_4__["default"].get(`https://api.themoviedb.org/3/tv/on_the_air?api_key=86ff22163d48cfd8567997262922738a&language=pt-br&page=1`);
    const toprated = await axios__WEBPACK_IMPORTED_MODULE_4__["default"].get(`https://api.themoviedb.org/3/discover/tv?api_key=86ff22163d48cfd8567997262922738a&language=pt-br&sort_by=popularity.desc&page=1&include_null_first_air_dates=false&with_watch_monetization_types=flatrate&with_status=0&with_type=0`);
    return {
        props: {
...
var __webpack_exports__ = __webpack_require__.X(0, [676,664,970,887,382,818], () => (__webpack_exec__(4914)));

...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async (req, res)=>{
    const result = await fetch(`${_lib_tmdb__WEBPACK_IMPORTED_MODULE_0__/* .apiBase */ .X}/trending/movie/week?api_key=${_lib_tmdb__WEBPACK_IMPORTED_MODULE_0__/* .apiKey */ .q}&language=pt-BR`);

...
import { FaAngleRight, FaClock, FaFacebook, FaFacebookF, FaRegClock, FaRegHandPeace, FaStar, FaTwitter, FaRegStar, FaComment, FaCommentAlt, FaCheckCircle, FaCheck, FaCircle } from 'react-icons/fa'
                        ...
                        <div className={styles.posterheadflex2}>
                            <div className={styles.posterheadflexC}>
                                ...
                                <div className={styles.buttonsPost}>
                                    <button className={styles.btn1}> <FaRegHandPeace /> CURTIR</button>
                                    <button className={styles.btn2}> <FaClock /> VER DEPOIS</button>
                                    <button className={styles.btn3}> <FaFacebookF /> </button>
                                    <button className={styles.btn4}>  <FaTwitter /> </button>
                    ...
                    <div className={styles.commentepublicrate}>
                        ...
                        <div className={`${styles.flex2cp} ${styles.flexT}`}>
                            <div className={styles.flex2cpContainer}>
                                ...
                                <h3 className={styles.subh3}>{info.title} Dulbado e Legendado</h3>
                                ...
                                <h3 className={styles.h3sub2}>Assitir {info.title} Online</h3>

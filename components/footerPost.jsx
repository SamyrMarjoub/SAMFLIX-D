    ...
    return (
        <>
            <footer className={styles.footer}>
                <div className={styles.footerpostdiv}>
                    <div className={styles.footerpostdiv1}><h1>Assistir {title.title} Online Grátis</h1></div>
                    <div className={styles.footerpostdiv2}>
                        <ul className={styles.ulfooterpost}>
                            <li>INÍCIO</li>
                            <li className={styles.listcircle}>ASSISTIR FILMES ONLINE GRÁTIS</li>
                            <li className={styles.listcircle} style={{ marginRight: '0px' }}>{title.title} ONLINE</li>
                ...
                <div className={styles.footerheaderdiv}>
                    ...
                    <div className={styles.divlists}>
                        <h4 className={styles.h4footer}>Aplicativo SamFlix</h4>
                        <ul>
